...
// entry. The app icon focuses the sender; the body activates the default action
// or raises the app; the chevron expands to show body + action buttons.
Item {
    id: root
    ...
    // Fresh label on appear — computed locally so we never write back to popups.
    ...
    Column {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                HoverHandler { cursorShape: Qt.PointingHandCursor }
                TapHandler {
                    onTapped: Notifications.focusPopupApp(root.modelData.id)
                }
            ...
            Item {
                ...
                HoverHandler { cursorShape: Qt.PointingHandCursor }
                TapHandler {
                    onTapped: Notifications.activatePopup(root.modelData.id)
                }
